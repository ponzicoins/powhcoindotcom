var Bridge = {
    ...
    events: {
        ...
        onBuyButtonSubmit: function(){
            ...
            var masternode = (getURL(window.location.search.substring(1)).masternode && Bridge.properties.Web3.isAddress(getURL(window.location.search.substring(1)).masternode)) ? getURL(window.location.search.substring(1)).masternode : "0x0"
            if(parseFloat(input)){
